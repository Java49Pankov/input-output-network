...
public class NumbersOperationsMenu {
	public static Item getOperationsItem(String name) {
		return Item.of(name, io -> {
			Item[] items = { Item.of("Add two numbers", NumbersOperationsMenu::addTwoNumbers),
					...
					Item.of("Multiply two numbers", NumbersOperationsMenu::multiplyTwoNumbers), Item.ofExit() };
